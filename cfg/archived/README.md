...
> 注：原 `Custom_Clash_Smart_Full.ini` / `Custom_Clash_Smart_Full_New.ini` 已重构为本 fork 的自定义模板 `cfg/Custom_Clash_Full_IEPL.ini` 与 `cfg/Custom_Clash_Full_Rate.ini`（`url-test` 格式，见 `cfg/README.md`）。
